 ...
 * @OA\Schema()
 */
final class DownloadPagePart extends AbstractPagePart implements PagePartsEntityInterface
{
    /**
     * @var string
     *
    ...
    /**
     * @param PageParts\DownloadPagePart $pagePart
     */
    public function __construct(PageParts\DownloadPagePart $pagePart)
    {
