 ...
 * @OA\Schema()
 */
final class RawHtmlPagePart extends AbstractPagePart implements PagePartsEntityInterface
{
    /**
     * @var string
     *
    ...
    /**
     * @param PageParts\RawHtmlPagePart $pagePart
     */
    public function __construct(PageParts\RawHtmlPagePart $pagePart)
    {
