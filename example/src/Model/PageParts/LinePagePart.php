 ...
 * @OA\Schema()
 */
final class LinePagePart extends AbstractPagePart implements PagePartsEntityInterface
{
    /**
     * @var string
     *
    ...
    /**
     * @param PageParts\LinePagePart $pagePart
     */
    public function __construct(PageParts\LinePagePart $pagePart)
    {
