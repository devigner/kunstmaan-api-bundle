...
use App\Form\PageParts\LinePagePartAdminType;
use App\Model;
 ...
 * @ORM\Entity
 */
class LinePagePart extends AbstractPagePart implements PagePartsModelInterface
{
    /**
     * Get the twig view.
     *
    ...
    {
        return new Model\PageParts\LinePagePart($this);
    }
}
