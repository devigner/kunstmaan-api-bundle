...
use App\Form\PageParts\RawHtmlPagePartAdminType;
use App\Model;
 ...
 * @ORM\Entity
 */
class RawHtmlPagePart extends AbstractPagePart implements PagePartsModelInterface
{
    /**
    ...
    {
        return new Model\PageParts\RawHtmlPagePart($this);
    }
}
